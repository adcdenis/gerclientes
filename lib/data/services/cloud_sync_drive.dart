...
import 'package:gerclientes/data/services/backup_codec.dart';
import 'package:gerclientes/data/services/cloud_sync_service.dart';
import 'package:gerclientes/core/cloud/cloud_config.dart';
...
class GoogleDriveCloudSyncService implements CloudSyncService {
  ...
  Future<void> _runStartupAutoSync() async {
    try {
      ...
      final regexp = RegExp(r"^gerclientes_backup_(\d{8}_\d{6})\.json");
  ...
  String _timestampName() {
    ...
    return 'gerclientes_backup_$ts.json';
  }
