...
class BackupServiceImpl implements BackupService {
  ...
  Future<String> exportPath() async {
    ...
    final filename = 'gerclientes_backup_$ts.json';
  ...
  Future<List<String>> listBackups() async {
    ...
    final files = await d
        .list()
        .where((e) => e is File && e.path.endsWith('.json') && RegExp(r'gerclientes_backup_\d{8}_\d{6}\.json').hasMatch(e.path.split(Platform.pathSeparator).last))
        .cast<File>()
        .toList();
    files.sort((a, b) {
