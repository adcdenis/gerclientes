        ...
        final title = Row(
          children: [
            Container(
              ...
              child: Icon(Icons.contact_page, color: Colors.blue, size: 24),
            ),
                      ...
                      children: [
                        Row(children: [
                          Container(
                            ...
                            child: const Icon(Icons.contact_page, color: Colors.blue, size: 24),
                          ),
                          const SizedBox(width: 8),
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Row(children: [
                Container(
                  ...
                  child: const Icon(Icons.contact_page, color: Colors.blue, size: 28),
                ),
                const SizedBox(width: 10),
